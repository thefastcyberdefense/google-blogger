...
export async function assets(){
 ...
 // Manual Prism plus a fixed grammar subset; no autoloader or runtime grammar requests.
...
export async function generateTheme(){
 ...
 console.log(`Built dist/theme.xml: ${bytes} bytes; CSS ${Buffer.byteLength(compiled.css)}; bundled JS ${Buffer.byteLength(compiled.script)}; source ${sha}`);
 return xml;
}
